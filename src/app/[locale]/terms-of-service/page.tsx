...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - The Elder Scrolls VI Wiki",
    description: "Read the Terms of Service for The Elder Scrolls VI Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our unofficial game information platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - The Elder Scrolls VI Wiki",
      description: "Terms and conditions for using The Elder Scrolls VI Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using The Elder Scrolls VI Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using The Elder Scrolls VI Wiki (&quot;the Website&quot;, &quot;we&quot;, &quot;our&quot;, or &quot;us&quot;), you agree to be bound
              by these Terms of Service (&quot;Terms&quot;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&quot;User&quot;, &quot;you&quot;, or &quot;your&quot;) and The Elder Scrolls VI Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              The Elder Scrolls VI Wiki is an unofficial, community-driven fan website that provides verified information, guides, and resources
              related to the upcoming Bethesda Game Studios title &quot;The Elder Scrolls VI&quot;. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Release date and development status updates</li>
              <li>Platform and availability coverage</li>
              <li>Setting, region, and lore analysis</li>
              <li>Trailer, screenshot, and media breakdowns</li>
              <li>Technology and engine information</li>
              <li>Community discussion and news verification</li>
            </ul>
            <p>
              <strong>Important:</strong> The Elder Scrolls VI Wiki is NOT affiliated with, endorsed by, or associated with
              Bethesda Game Studios, Microsoft, Xbox, or the official developers of The Elder Scrolls VI. We are an independent fan community.
              The game has not yet been released, and some content reflects analysis, speculation, or community discussion rather than confirmed facts.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by The Elder Scrolls VI Wiki and are protected by international
              copyright, trademark, and other intellectual property laws.
            </p>

            <h3>4.2 Game Content</h3>
            <p>
              All game-related content, including but not limited to trailer stills, artwork, logos, and
              trademarks, are the property of Bethesda Game Studios, Microsoft, and/or their respective owners. We use such
            ...
            <ul>
              <li><strong>Accuracy:</strong> We strive to provide accurate and verified information, but because The Elder Scrolls VI has not been released, some content includes analysis, rumors, or speculation. We do not guarantee that all content is current, complete, or error-free.</li>
              ...
              <li><strong>Unreleased Game:</strong> Release dates, platforms, setting, and gameplay details may change. Official information from Bethesda Game Studios supersedes anything published on this Website.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, THE ELDER SCROLLS VI WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              The Website may contain links to third-party websites, including Bethesda, Discord, Reddit, YouTube, social media platforms,
            ...
            <p>
              ...
              you and The Elder Scrolls VI Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@theelderscrollsvi.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@theelderscrollsvi.wiki</a>
            </p>
            <p>
